...
public class Main {
    ...
    public static void main(String[] args) {
        // Creating a new handler.LoginHandler object.
        ...
        LoginInformation loginInformation = loginHandler.logIn(username, password);
        ...
        SignupInformation signupInformation = loginHandler.signUp(username, password);
        ...
        LoginInformation loginInformation2 = loginHandler.logIn(username2, password2);

        if (loginInformation2.equals(LoginInformation.SUCCESSFUL_LOGIN)) {
        ...
        SignupInformation signupInformation2 = loginHandler.signUp(username2, password2);

        if (signupInformation2.equals(SignupInformation.SUCCESSFUL_SIGNUP)) {
